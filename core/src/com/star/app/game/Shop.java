...
public class Shop extends Group {
    private Hero hero;
    private BitmapFont font24; //для надписей на кнопочках
    ...
    public Shop(final Hero hero) {
        ...
        Pixmap pixmap = new Pixmap(400,400, Pixmap.Format.RGB565); //размер экрана магазина
...
//        кнопка закрытия магазина
        ...
        btnClose.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                hero.resumeGame(false);
            }
        });

        btnClose.setTransform(true);
        btnClose.setScale(0.4f); //размер кнопки
        btnClose.setPosition(360,360);
        this.addActor(btnClose);

//  кнопки выбора товаров в магазине

        final TextButton btnHpMax = new TextButton("Life\nMax_10",textButtonStyle);
        ...
        final TextButton btnHp = new TextButton("Life\n20",textButtonStyle);
        ...
        final TextButton btnWeapon = new TextButton("Weapon\n100",textButtonStyle);
        ...
        final TextButton btnMagnet = new TextButton("Magnet\n50",textButtonStyle);
